        ...
        return (
            <Row gutter={12}>
                <Col span={18}>
                    <Form onSubmit={this.handleSaveBooking}>
                        <Row gutter={12}>
                            <Col span={12}>
                                <FormItem label="Language">
                                    {getFieldDecorator('language', config.language)(
                                        <Select>
                            ...
                            <Col span={12}>
                                <FormItem label="Currency">
                                    {getFieldDecorator('currency', config.currency)(
                                        <Select>
                            ...
                            <Col span={12}>
                                <FormItem label="Check in - Check out" >
                                    {getFieldDecorator('checkInOut', config.checkInOut)(
                                        <RangePicker
                            ...
                            <Col span={4}>
                                <FormItem label="# People">
                                    {getFieldDecorator('qty_people', config.people)(
                                        <InputNumber
                                            style={{ width: '100%' }} />)}
                                </FormItem>
                            </Col>
                            ...
                            <Col span={8}>
                                <FormItem label="Client Name">
                                    {getFieldDecorator('user_name', config.clientName)(
                                        <Input
                            ...
                            <Col span={8}>
                                <FormItem label="Client Email">
                                    {getFieldDecorator('user_email', config.clientEmail)(
                                        <Input placeholder="john@jetsemani.com" />)}
                                </FormItem>
                            </Col>
                            <Col span={8}>
                                <FormItem
                            ...
                            <Col span={24}>
                                <FormItem label="Message from client">
                        ...
                        <Row gutter={12} type="flex" justify="center">
                            <Col
                                span={3}>
                                <Link className="ant-btn ant-btn-primary width-parent">Cancel</Link>
                            </Col>
                            <Col
                                span={3} >
                ...
                <Col
                    ...
                    <Form
                        onSubmit={this.sendBooking}>
                        <FormItem label="Summary">
                            {this.getSummary()}
                        </FormItem>
                        <Col span={24}>
                            <FormItem label="Payment Requests">
                                {getFieldDecorator('min_payment')(
                                    <RadioGroup>
...
export default connect(null, mapDispatchToProps)(Form.create()(BookingsManagement))